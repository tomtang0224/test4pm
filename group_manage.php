...
<body>
    ...
    <div class="container mt-5">
        ...
        <form action="create_group_t.php" method="post">
            <div class="row">
                <div class="col">
                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        while ($group = $result->fetch_assoc()) {
                            ...
                            echo '<td>';
                            echo '<a href="edit_group_form_t.php?id=' . $group['id'] . '" class="btn btn-primary btn-sm">Edit</a> ';
                            echo '<a href="delete_group_t.php?course_id=' . $courseId . '&id=' . $group['id'] . '" class="btn btn-danger btn-sm">Delete</a>';
                            echo '</td>';
                            echo '</tr>';
                        }
                    } else {
