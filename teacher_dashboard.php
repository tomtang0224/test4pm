            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while ($course = $result->fetch_assoc()) {
                        ...
                        echo '<td><a href="group_process.php?course_id=' . $course['Course_id'] . '" class="btn btn-primary btn-sm">View Groups</a> ';
                        echo '<a href="group_manage.php?course_id=' . $course['Course_id'] . '" class="btn btn-primary btn-sm">Manage Groups</a></td>';
                        echo '</tr>';
                    }
                } else {
